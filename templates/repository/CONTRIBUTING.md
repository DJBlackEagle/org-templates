...
> sensitive bugs must be sent by email to [{ TPL^EMAIL_NAME_SECURITY }][REF_INTERN_EMAIL_ADDRESS_SECURITY].
...
{ TPL^PACKAGE_FULLNAME }, **including completely new features and minor
...
- **Describe the current behavior** and **explain which behavior you expected to
  ...
  not work for you.
- **Explain why this enhancement would be useful** to most { TPL^PACKAGE_FULLNAME }
