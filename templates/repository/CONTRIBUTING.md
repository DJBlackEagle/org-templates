# Contributing to { TPL^PACKAGE_FULLNAME } <!-- omit in toc -->
...
- **Explain why this enhancement would be useful** to most { TPL^PACKAGE_FULLNAME } users. You may also want to point out the other projects that solved it better and which could serve as inspiration.
...
We follow the commit message policy based on the '[Conventional Commits][REF_INTERN_URL_COMMIT_MESSAGE_FORMAT]' rules.
